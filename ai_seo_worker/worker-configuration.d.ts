/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0093aebca1a6e9c4e705332d0aba7ed4)
// Runtime types generated with workerd@1.20260601.1 2025-06-01 nodejs_compat
interface __BaseEnv_Env {
	CONTENT_BUCKET: R2Bucket;
	VECTORIZE: VectorizeIndex;
	AI: Ai;
	SEO_WORKFLOW: Workflow<Parameters<import("./src/index").SEOContentWorkflow['run']>[0]['payload']>;
}
