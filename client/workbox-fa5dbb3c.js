define(["exports"], function (t) {
	...
	class l {
		constructor(t = {}) {
			(this.h = t.statuses), (this.l = t.headers);
		}
	...
	class R {
		...
		async cacheMatch(t) {
			const e = m(t);
			let s;
			const { cacheName: n, matchOptions: r } = this.p,
	...
	class v {
		...
		handleAll(t) {
			...
			const e = t.event,
				...
				i = this.L(r, s, e);
			return [i, this._(i, r, s, e)];
		}
		async L(t, e, n) {
			let r;
			await t.runCallbacks("handlerWillStart", { event: n, request: e });
			try {
				if (((r = await this.C(e, t)), !r || "error" === r.type))
	...
	class P {
		...
		addToCacheList(t) {
			...
			for (const n of t) {
				...
				if ((this.k.set(r, t), this.j.set(r, i), e.length > 0)) {
