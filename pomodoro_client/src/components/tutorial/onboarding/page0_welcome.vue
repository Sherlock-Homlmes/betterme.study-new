...
OnboardingPage
  ...
  OptionGroup(class="w-full" :choices="$languages" :value="userSettings.language" :override-text="{ title: $languages, description: {} }" @input="(newLang) => { userSettings.language = newLang }")
</template>
