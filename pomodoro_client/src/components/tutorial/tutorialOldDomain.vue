...
popup-sheet(class="fixed w-full max-w-2xl md:p-4" open)
  div(class="flex flex-col px-6 pt-6 pb-6 transition bg-surface-light dark:bg-surface-dark md:backdrop-blur-xl md:backdrop-brightness-200 md:backdrop-contrast-50 md:bg-surface-light/80 md:dark:bg-surface-dark/80 shadow-lg md:pb-3 rounded-t-2xl md:rounded-2xl max-h-[90vh] dark:ring-1 dark:ring-surface-ondark/20 md:ring-inset gap-4")
    ExclamationCircleIcon(class="text-primary mx-auto -mb-2" :size="48")
    h2(class="text-2xl font-bold text-center" v-text="$t('tutorials.olddomain.heading')")
