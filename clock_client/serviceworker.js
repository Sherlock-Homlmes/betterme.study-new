if (!self.define) {
	...
	self.define = (i, c) => {
		...
		let f = {};
		const r = (e) => n(e, a),
			o = { module: { uri: a }, exports: f, require: r };
		s[a] = Promise.all(i.map((e) => o[e] || r(e))).then((e) => (c(...e), f));
	};
}
	...
	e.enable(),
		...
		e.precacheAndRoute(
			[
				...
				{
					url: "components.json",
					revision: "3eedb8810cf522fffdb8cf4713cf904f",
				},
				...
				{ url: "jsconfig.json", revision: "067bb768824c14fda1bb7415145a9687" },
				{
					...
					revision: "a86f2dcbe3418647f32b750bcdd2f3d9",
				},
				{ url: "package.json", revision: "1d1c7651acf7b2bc276b62cb739b03ea" },
				{
				...
				},
				{
					...
					revision: "042c862840543dac74ede7f8dff6e575",
				},
